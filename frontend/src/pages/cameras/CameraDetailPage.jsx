  ...
  const loadCameraDetails = async () => {
    ...
    try {
      ...
      setGeneralForm({
        ...
        mountingHeight: data.mountingHeight !== null && data.mountingHeight !== undefined ? data.mountingHeight.toString() : '',
        orientation: data.orientation !== null && data.orientation !== undefined ? data.orientation.toString() : '',
        tiltAngle: data.tiltAngle !== null && data.tiltAngle !== undefined ? data.tiltAngle.toString() : '',
      ...
      if (data.specification) {
        setSpecForm({
          ...
          fps: data.specification.fps !== null && data.specification.fps !== undefined ? data.specification.fps.toString() : '',
          lens: data.specification.lens || '',
          focalLength: data.specification.focalLength || '',
          fieldOfView: data.specification.fieldOfView !== null && data.specification.fieldOfView !== undefined ? data.specification.fieldOfView.toString() : '',
      ...
      if (data.streamConfig) {
        setStreamForm({
          ...
          port: data.streamConfig.port !== null && data.streamConfig.port !== undefined ? data.streamConfig.port.toString() : '',
      ...
      if (data.aiConfig) {
        setAiForm({
          ...
          faceMatchThreshold: data.aiConfig.faceMatchThreshold || 0.80,
          loiteringThresholdSeconds: data.aiConfig.loiteringThresholdSeconds || 300,
  ...
  const handleGeneralSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        mountingHeight: generalForm.mountingHeight ? parseFloat(generalForm.mountingHeight) : null,
        orientation: generalForm.orientation ? parseFloat(generalForm.orientation) : null,
        tiltAngle: generalForm.tiltAngle ? parseFloat(generalForm.tiltAngle) : null,
        installedAt: generalForm.installedAt ? new Date(generalForm.installedAt).toISOString() : null,
      };
  ...
  const handleSpecSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        fieldOfView: specForm.fieldOfView ? parseFloat(specForm.fieldOfView) : null,
  ...
  const handleAISubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        loiteringThresholdSeconds: parseInt(aiForm.loiteringThresholdSeconds, 10),
  ...
  if (!camera) {
    return (
      <div className="detail-error-state">
        ...
        <button onClick={() => navigate('/cameras')} className="btn-back">
        ...
        <div className="detail-header-left">
          ...
          <div>
            ...
            <div className="detail-badges-row">
              <span className={`status-badge badge-${camera.status.toLowerCase()}`}>
                {camera.status === 'ACTIVE' ? 'Đang chạy' : 'Đã tắt'}
              </span>
              <span className={`status-badge op-badge-${camera.operationalStatus.toLowerCase()}`}>
                ● {camera.operationalStatus}
              </span>
              {camera.floor && <span className="location-tag">Tầng {camera.floor}</span>}
              {camera.zoneName && <span className="location-tag">{camera.zoneName}</span>}
            </div>
          </div>
        </div>
      ...
      <div className="detail-grid">
        <div className="config-card">
          ...
          <div className="tab-content">
            {/* GENERAL TAB */}
            {activeTab === 'general' && (
              <form onSubmit={handleGeneralSubmit} className="tab-form">
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setGeneralForm({ ...generalForm, zoneName: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    <label>Toạ độ X (Pixel)</label>
                    <input
                      type="number"
                      step="0.01"
                      value={generalForm.x}
                      onChange={(e) => setGeneralForm({ ...generalForm, x: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    <label>Toạ độ Y (Pixel)</label>
                    <input
                      type="number"
                      step="0.01"
                      value={generalForm.y}
                      onChange={(e) => setGeneralForm({ ...generalForm, y: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setGeneralForm({ ...generalForm, mountingHeight: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    <label>Góc quay (độ)</label>
                    <input
                      type="number"
                      step="0.1"
                      value={generalForm.orientation}
                      onChange={(e) => setGeneralForm({ ...generalForm, orientation: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    <label>Góc nghiêng (độ)</label>
                    <input
                      type="number"
                      step="0.1"
                      value={generalForm.tiltAngle}
                      onChange={(e) => setGeneralForm({ ...generalForm, tiltAngle: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setGeneralForm({ ...generalForm, installedAt: e.target.value })}
                    />
                  </div>
            ...
            {activeTab === 'specification' && (
              <form onSubmit={handleSpecSubmit} className="tab-form">
                <div className="form-grid">
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setSpecForm({ ...specForm, serialNumber: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setSpecForm({ ...specForm, resolution: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      type="number"
                      value={specForm.fps}
                      onChange={(e) => setSpecForm({ ...specForm, fps: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      type="text"
                      value={specForm.lens}
                      onChange={(e) => setSpecForm({ ...specForm, lens: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setSpecForm({ ...specForm, focalLength: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setSpecForm({ ...specForm, fieldOfView: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setSpecForm({ ...specForm, firmwareVersion: e.target.value })}
                    />
                  </div>
                  <div className="form-group col-span-2 checkbox-row">
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) => setSpecForm({ ...specForm, nightVision: e.target.checked })}
                      />
                    ...
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) => setSpecForm({ ...specForm, ptzSupported: e.target.checked })}
                      />
                    ...
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) => setSpecForm({ ...specForm, weatherProof: e.target.checked })}
                      />
            ...
            {/* STREAM TAB */}
            {activeTab === 'stream' && (
              <form onSubmit={handleStreamSubmit} className="tab-form">
                <div className="form-grid">
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setStreamForm({ ...streamForm, host: e.target.value })}
                      required
                    />
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    <label>Mã khoá xác thực (Credential Ref)</label>
                    <input
                      type="text"
                      value={streamForm.credentialRef}
                      onChange={(e) => setStreamForm({ ...streamForm, credentialRef: e.target.value })}
                    />
                  </div>
                  <div className="form-group col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setStreamForm({ ...streamForm, mainStreamUrl: e.target.value })}
                      required
                    />
                  </div>
                  <div className="form-group col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setStreamForm({ ...streamForm, subStreamUrl: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setStreamForm({ ...streamForm, timeoutMs: e.target.value })}
                    />
                  </div>
                  <div className="form-group col-span-2 checkbox-row">
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) => setStreamForm({ ...streamForm, streamEnabled: e.target.checked })}
                      />
                    ...
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) => setStreamForm({ ...streamForm, reconnectEnabled: e.target.checked })}
                      />
            ...
            {/* AI CONFIG TAB */}
            {activeTab === 'ai' && (
              <form onSubmit={handleAISubmit} className="tab-form">
                <div className="form-grid">
                  <div className="form-group">
                    <label>Ngưỡng khớp khuôn mặt (Face match threshold: {aiForm.faceMatchThreshold})</label>
                    <div className="slider-wrapper">
                      <input
                        ...
                        onChange={(e) => setAiForm({ ...aiForm, faceMatchThreshold: e.target.value })}
                      />
                    </div>
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setAiForm({ ...aiForm, loiteringThresholdSeconds: e.target.value })}
                      required
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setAiForm({ ...aiForm, inferenceFps: e.target.value })}
                      required
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setAiForm({ ...aiForm, modelVersion: e.target.value })}
                    />
                  </div>
                  <div className="form-group col-span-2 checkbox-row">
                    <label className="checkbox-label toggle-switch">
                      <input
                        ...
                        onChange={(e) => setAiForm({ ...aiForm, personDetectionEnabled: e.target.checked })}
                      />
                    ...
                    <label className="checkbox-label toggle-switch">
                      <input
                        ...
                        onChange={(e) => setAiForm({ ...aiForm, faceRecognitionEnabled: e.target.checked })}
                      />
                    ...
                    <label className="checkbox-label toggle-switch">
                      <input
                        ...
                        onChange={(e) => setAiForm({ ...aiForm, loiteringDetectionEnabled: e.target.checked })}
                      />
                  ...
                  <tbody>
                    {logs.map((log) => (
                      <tr key={log.id}>
                        ...
                        <td>
                          <span className={`status-badge text-small op-badge-${log.status.toLowerCase()}`}>
                            {log.status}
                          </span>
                        </td>
                        <td>{log.latencyMs !== null ? `${log.latencyMs} ms` : '-'}</td>
                        <td>{log.fps !== null ? `${log.fps} fps` : '-'}</td>
                        <td className="text-red font-bold text-small" title={log.errorMessage}>
                          {log.errorCode || '-'}
                        </td>
                      </tr>
                    ))}
